...
<div class="content">
	...
	<form id="form" action="/login" method="post">
		<input class="login_input" id="username" name="username" placeholder="아이디" type="text"><br>
		<input class="login_input" id="password" name="password" placeholder="비밀번호" type="password"><br>
		...
		<input id="loginFailMsgInput" type="text" value="${loginFailMsg}" readonly/>
	</form>
